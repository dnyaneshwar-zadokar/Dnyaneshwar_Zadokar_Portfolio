  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Dnyaneshwar Zadokar</strong> — an aspiring{" "}
          <strong>Full Stack Web Developer</strong> and{" "}
          <strong>Tech enthusiast</strong> who loves turning ideas
        ...
        <p>
            BCA Final Year Student specializing in Full Stack Development, turning ideas into interactive and intelligent web solutions.
        </p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>S.G.B.A.U (University)</strong> — Amravati,
                  Maharastra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  3th Year (Pursuing) | GPA: 8.52
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Shri Shivshankar Jr. College</strong> — Ural, Akola
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Maharastra Board | Percentage: 75%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Shri Shivshankar Vidyalaya</strong> — Ural,
                  Akola
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Maharashtra Board | Percentage: 90.6%
                </p>

...
// 🖼️ Import Assets
import photo from '../../public/Dnyaneshwar Zadokar Photo.jpg'
...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/dnyaneshwar-zadokar' },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
          Aritificial Intellegence Enthusiastic | Full Stack Developer | Tech Explorer
          </p>
          ...
          >
            {[ 
              { label: '📍 Location', value: 'Akola, Maharashtra, India' },
              { label: '💼 Expertise', value: 'Full Stack Developer' },
              { label: '📧 Contact', value: 'dnyaneshwarzadokar227@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
